...
import CreateJob from "./modalJobCreate";
...
function EditToolbar(props) {
  ...
  return (
    <>
      ...
      <CreateJob Open={OpenReg} Close={handleCloseReg}></CreateJob>
    </>
  );
}

function DataGridJobs({ rowData, companyList }) {
  ...
  const handleDeleteClick = (id) => async () => {
    if (confirm("Do you want Delete this job Information?")) {
      await Axios.post("api/jobs/deleteJobs", { id: id }).then((res) => {
        if (res.data.success) {
  ...
  const processRowUpdate = async (newRow) => {
    if (confirm("Do you want change job Information?")) {
