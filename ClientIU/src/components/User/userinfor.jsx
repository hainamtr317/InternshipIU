      ...
      <Box>
        ...
        <Typography variant="h6">{dataUser.name}</Typography>
          ...
          <Box sx={stylebox}>
            ...
            <Typography sx={{ ml: "20px" }}>Address:  {dataUser.job.Address}</Typography>
        ...
        <Box sx={stylebox}>
          ...
          <Box sx={stylebox}>
            ...
            <Typography sx={{ ml: "20px" }}>email:  {dataUser.instructor.email}</Typography>
        ...
        <Box>
        <Box sx={stylebox}>
            <Typography sx={{fontWeight: 'bold'}}>Your procession internship:</Typography>
          </Box>
          <Divider></Divider>
          <Box sx={{ width: "auto", marginTop: "20px" }}>
            <Stepper sx={{ width: "auto" }} activeStep={dataUser.progressionStatus} alternativeLabel>
              {steps.map((label) => (
                <Step key={label}>
                  <StepLabel>
